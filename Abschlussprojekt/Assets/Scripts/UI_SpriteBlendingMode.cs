...
namespace CustomBlendModes
{
    ...
    [ExecuteAlways]
    public class UI_SpriteBlendingMode : MonoBehaviour
    {
        ...
        // References to the Image and its material instance
        ...
        {
            // Get the Image on this GameObject
            if (Image == null)
                Image = GetComponent<UnityEngine.UI.Image>();

            // Create a new instance of the material if needed
            if (Image != null && (Image.material == null || Image.material != materialInstance))
            {
    ...
    #if UNITY_EDITOR
    [CustomEditor(typeof(UI_SpriteBlendingMode))]
    public class UI_SpriteBlendingModeEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            UI_SpriteBlendingMode sbm = (UI_SpriteBlendingMode)target;
